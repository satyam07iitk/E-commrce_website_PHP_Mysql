                    ...
                    <form method="POST" action="" name="sentMessage" id="contactForm" >
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input name="phone" type="number" class="form-control" placeholder="Your Phone *" id="phone" required data-validation-required-message="Please enter your phone number.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"></div>
                                <button type="submit" name="contactSubmit" class="btn btn-xl">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
